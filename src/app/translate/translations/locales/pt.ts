const translations = {
  ...
  translation: {
    ...
    textJobs: "Trabalhos de Texto",
    documentJobs: "Trabalhos de Documento",
    status: "Status",
    filterByStatus: "Filtrar por Status",
    noJobsMatch: "Nenhum trabalho corresponde aos critérios",
    adjustFilters: "Tente ajustar seus filtros",
    searchJobs: "Pesquisar trabalhos",
    discardChanges: "Descartar Alterações Não Salvas?",
    unsavedChangesDesc: "Você tem alterações não salvas. Tem certeza de que deseja descartá-las e cancelar a edição deste trabalho?",
    keepEditing: "Continuar Editando",
    discardAndReset: "Descartar e Redefinir",
    deleteJobConfirm: "Excluir Trabalho?",
    deleteJobDesc: "Tem certeza de que deseja excluir o trabalho \"{jobName}\"? Esta ação não pode ser desfeita.",
    maxFiles: "Máx. {max} arquivos. Máx. {size}MB no total.",
    browseFiles: "Procurar Arquivos",
    selectedFiles: "Arquivos Selecionados ({count}/{max}):",
    togglePdfDocx: "Alternar PDF→DOCX",
    pdfToDocxTooltip: "Converter PDF para DOCX na tradução",
    removeFile: "Remover arquivo",
    translatedDocuments: "Documentos Traduzidos para {language}:",
    download: "Baixar",
    downloadSelected: "Baixar Selecionados",
    downloadAllZip: "Baixar Todos como ZIP",
    translationIssues: "Problemas de Tradução",
    actionCancelled: "Ação Cancelada",
    actionCancelledDesc: "A operação atual foi cancelada."
  },
