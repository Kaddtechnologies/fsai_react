const translations = {
  ...
  translation: {
    ...
    // Toast messages
    jobSaved: "ジョブが保存されました",
    jobSavedDesc: "'{name}'が正常に保存されました",
    jobDeleted: "ジョブが削除されました",
    jobArchived: "ジョブがアーカイブされました",
    jobUnarchived: "ジョブがアーカイブから削除されました",
    copiedToClipboard: "クリップボードにコピーしました",
    jobTypeSwitched: "ジョブタイプが切り替わりました",
    jobTypeSwitchedDesc: "以前のデータは削除されました",
    nothingToSave: "保存するものがありません",
    nothingToSaveDesc: "保存するアクティブなジョブがありません",
    
    // Error messages
    jobTitleRequired: "ジョブタイトルが必要です",
    jobTitleRequiredDesc: "このジョブにタイトルを入力してください",
    jobTitleRequiredDesc2: "翻訳する前にタイトルを入力してください",
    inputRequired: "テキストが必要です",
    inputRequiredDesc: "翻訳するテキストを入力してください",
    errorTitle: "エラー",
    errorStartTranslationDesc: "翻訳を開始できませんでした",
    translationError: "翻訳エラー",
    translationErrorDesc: "翻訳を完了できませんでした",
    
    // Status notifications
    translationComplete: "翻訳完了",
    translationCompleteDesc: "'{title}'が正常に翻訳されました",
    documentJobComplete: "ドキュメント翻訳完了",
    documentJobCompleteDesc: "'{title}'が正常に処理されました",
    documentJobIssues: "ドキュメントジョブの問題",
    documentJobIssuesDesc: "'{title}'の処理中に問題が発生しました",
    jobUpdated: "ジョブが更新されました",
    jobUpdatedDesc: "'{title}'が更新されました",
    
    // File processing messages
    fileLimitReached: "ファイル制限に達しました",
    fileLimitReachedDesc: "ジョブあたり最大{max}ファイル",
    invalidFileType: "無効なファイルタイプ",
    invalidFileTypeDesc: "'{fileName}'はサポートされていません",
    sizeLimitExceeded: "サイズ制限を超えました",
    sizeLimitExceededDesc: "合計サイズが{max}MBを超えています",
    fileProcessed: "ファイルが処理されました",
    fileProcessedDesc: "'{fileName}'が正常に処理されました",
    fileFailed: "ファイル処理に失敗しました",
    fileFailedDesc: "'{fileName}'を処理できませんでした",
    allFilesProcessed: "すべてのファイルが処理されました",
    allFilesProcessedDesc: "すべてのファイルはすでに処理されています",
    noFilesUploaded: "ファイルがアップロードされていません",
    noFilesUploadedDesc: "少なくとも1つのファイルをアップロードしてください",
    noFilesSelected: "ファイルが選択されていません",
    noFilesSelectedDesc: "少なくとも1つのファイルを選択してください",
    downloadSelectedSimulated: "シミュレートされたダウンロード",
    downloadSelectedSimulatedDesc: "以下のシミュレートされたダウンロード: {fileList}",
    downloadAllZipSimulated: "シミュレートされたZIPダウンロード",
    downloadAllZipSimulatedDesc: "{count}ファイルのZIPとしてのシミュレートされたダウンロード",
    noTranslatedFiles: "翻訳されたファイルがありません",
    noTranslatedFilesDesc: "この言語向けの翻訳ファイルはありません",
    downloadSimulated: "シミュレートされたダウンロード",
    downloadSimulatedDesc: "'{fileName}'のシミュレートされたダウンロード"
  },
